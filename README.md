...
The configuration file path depends on which surface you use:

| Surface | Config file |
|---|---|
| **AGY CLI** (`agy` terminal) | `~/.gemini/antigravity-cli/mcp_config.json` |
| **Antigravity IDE / 2.0** | `~/.gemini/config/mcp_config.json` |
